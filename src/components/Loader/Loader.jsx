        ...
        <div className="bg-white  flex justify-center items-center w-screen h-screen p-5">
            <div className=" p-2 rounded-md ">
                <div className="flex items-end gap-1">
                    <span className="text-6xl animate-bounce font-semibold ">n</span>
                    <svg
                    ...
                    {/* <span className="text-6xl font-semibold ">o</span> */}
                    <span className="text-6xl animate-bounce font-semibold ">t</span>
                    <span className="text-6xl animate-bounce font-semibold ">e</span>
                    <span className="text-6xl animate-bounce font-semibold ">'s</span>
                </div>
            </div>
        </div>
    );
